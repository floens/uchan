...
class SiteConfigurationForm(CSRFForm):
    ...
    registration = BooleanField(
        "Moderator registration", default=True, description="Allow registration"
    )
    board_creation = BooleanField(
        "Board creation",
        default=True,
        description="Allow creation of boards by moderators. If disabled, only admins"
    ...
    motd = TextAreaField(
        ...
        [Length(max=500)],
        default="",
        description="The message of the day is displayed at the top of every board "
        "page.",
