...
def generate_crypt_code(password):
    """generates an insecure crypt() tripcode futuba style, all the quirks included

    supports passwords with japanese chars, just feed it a python 3 unicode string
    """
