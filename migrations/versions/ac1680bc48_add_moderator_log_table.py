...
def upgrade():
    ...
    op.create_index(
        op.f("ix_moderatorlog_board_id"), "moderatorlog", ["board_id"], unique=False
    )
    op.create_index(
        op.f("ix_moderatorlog_date"), "moderatorlog", ["date"], unique=False
    )
    op.create_index(
        op.f("ix_moderatorlog_moderator_id"),
        "moderatorlog",
        ["moderator_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_moderatorlog_type"), "moderatorlog", ["type"], unique=False
    )
