...
def upgrade():
    ...
    op.create_index(
        op.f("ix_thread_last_modified"), "thread", ["last_modified"], unique=False
    )
    op.create_table(
        "post",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_post_moderator_id"), "post", ["moderator_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_file_thumbnail_location"), "file", ["thumbnail_location"], unique=False
    )
    op.create_table(
        "report",
        sa.Column("id", sa.Integer(), nullable=False),
